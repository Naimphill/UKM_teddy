        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url('Adminpanel') ?>" class="nav-link" href="<?php base_url('') ?>">
                            <span class="menu-title">Dashboard</span>
                            <i class="mdi mdi-home menu-icon"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo site_url('Adminpanel/data_admin') ?>" class="nav-link">
                            <span class="menu-title">Data Admin</span>
                            <i class="mdi mdi-contacts menu-icon"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo site_url('Adminpanel/data_ukm') ?>" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url('Adminpanel/kegiatan') ?>" class="nav-link">
