        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url('Ukm') ?>" class="nav-link" href="<?php base_url('') ?>">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url('Ukm/info_ukm') ?>" class="nav-link">
                            <span class="menu-title">Info Kegiatan UKM</span>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url('Login_ukm/logout') ?>" class="nav-link tombolkeluar">
